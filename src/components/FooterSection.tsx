      ...
      <div className="container px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="font-bold text-xl">Hireby<span className="text-primary">AI</span></span>
            </Link>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/in/tushar-prajapati-1ab5b3221/" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between">
          <div className="text-sm text-muted-foreground">
            <p>&copy; {new Date().getFullYear()} HirebyAI. All rights reserved.</p>
            <p className="mt-1">Developed by <a href="https://www.linkedin.com/in/tushar-prajapati-1ab5b3221/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Tushar Prajapati</a></p>
          </div>
